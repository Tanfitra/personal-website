                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12">
                        ...
                        <div className="flex-1 mt-4 md:mt-0">
                            ...
                            <p className="text-gray-300 leading-relaxed mb-4 text-justify md:mr-0 lg:mr-8">
                                A Information Systems graduate with a passion
                                for web development. Skilled in JavaScript
                                frameworks such as React and Next.js, as well as
                                PHP with Laravel, with hands-on experience in
                                developing interactive and responsive web
                                applications. In addition to development,
                                actively using Git for version control and
                                Trello for project management, ensuring
                                effective collaboration and structured
                                workflows. Committed to continuous learning and
                                eager to explore new tools, frameworks, and best
